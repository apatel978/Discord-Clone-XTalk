...
def seed_servers():
    demoServer = Server(name='DemoServer', owner_id=1, preview='https://static.vecteezy.com/system/resources/previews/003/673/767/original/x-letter-logo-icon-for-business-and-company-vector.jpg')
    anotherDemo = Server(name='Test2', owner_id=2, preview='https://static.vecteezy.com/system/resources/previews/003/673/767/original/x-letter-logo-icon-for-business-and-company-vector.jpg')
    DianaDemo = Server(name='Diana', owner_id=3, preview='https://static.vecteezy.com/system/resources/previews/003/673/767/original/x-letter-logo-icon-for-business-and-company-vector.jpg')
    OlehDemo = Server(name='Oleh', owner_id=1, preview='https://static.vecteezy.com/system/resources/previews/003/673/767/original/x-letter-logo-icon-for-business-and-company-vector.jpg')
    AksharDemo = Server(name='Akshar', owner_id=2, preview='https://static.vecteezy.com/system/resources/previews/003/673/767/original/x-letter-logo-icon-for-business-and-company-vector.jpg')
